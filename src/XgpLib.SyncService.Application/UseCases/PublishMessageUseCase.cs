...
/// <param name="messageBrokerService">Message broker service instance</param>
public class PublishMessageUseCase(
    ILogger<PublishMessageUseCase> logger,
    IMessageBrokerService messageBrokerService)
{
    private readonly ILogger<PublishMessageUseCase> _logger = logger;
